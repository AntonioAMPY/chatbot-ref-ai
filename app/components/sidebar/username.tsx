...
export function UserName({ userName }: UserNameProps) {
  ...
  return (
    <div className="flex flex-row gap-x-2 items-center text-white rounded-sm mt-auto capitalize w-full justify-between" role="contentinfo">
      <div className="flex items-center gap-x-2">
        <CircleImage
          src={"/icons/cat-user-profile-white.svg"}
          alt={"User profile photo - welcome"}
        />
        <h3 className="font-bold" id="userName">{userName}</h3>
      </div>
      <button
